    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <div className='flex gap-4 ml-5'>
          <a href="https://www.linkedin.com/in/ankit-variya-243101158/" target="_blank" rel="noopener noreferrer">
            <img src={linkedin} alt="LinkedIn" className='w-9 h-9' />
          </a>
          <a href="https://github.com/ankit-variya" target="_blank" rel="noopener noreferrer">
